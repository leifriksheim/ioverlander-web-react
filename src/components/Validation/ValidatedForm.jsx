...
import { createForm, onChange, onValidate, onFocus, touchAll, validateSingle, validationStart, validationComplete } from '../../actions/validation/validationActions'
...
export default function createValidatedForm (Component, fields, validation, getDefaultValues) {
  ...
  }, null, null, { withRef: true, pure: false })(ValidatedForm)
}
